...
/**
 * Standard Verhoeff Checksum Algorithm used by UIDAI for Indian Aadhaar verification.
 * Deterministic, offline, instant validation.
 */
object Verhoeff {
    ...
    fun validate(num: String): Boolean {
        val clean = num.replace("\\s+".toRegex(), "").replace("-", "")
